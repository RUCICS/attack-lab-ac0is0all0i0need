...
0000000000001209 <caesar_decrypt>: 
    ...
    1219:	89 75 d4             	mov    %esi,-0x2c(%rbp)#接收两个参数
    121c:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax #仍然是有canary的
    1223:	00 00 
...
000000000000135d <func>:
    ...
    136c:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax #也有cannary
    1373:	00 00 
    ...
    140e:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax #检查canary
    1415:	00 00 
...
0000000000001420 <main>:
    ...
    142f:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax # 这里还有cannary呢
    1436:	00 00 
    1438:	48 89 45 f8          	mov    %rax,-0x8(%rbp) #保存cannary的值
    143c:	31 c0                	xor    %eax,%eax # 归零eax
    ...
    1468:	e8 43 fc ff ff       	call   10b0 <puts@plt> # 输出
    ...
    1483:	e8 68 fc ff ff       	call   10f0 <__isoc99_scanf@plt> #读入第一个
    ...
    14e3:	e8 08 fc ff ff       	call   10f0 <__isoc99_scanf@plt>  #读入
    ...
    157f:	e8 6c fb ff ff       	call   10f0 <__isoc99_scanf@plt> #读入
    1584:	8b 85 60 ff ff ff    	mov    -0xa0(%rbp),%eax
    158a:	89 c7                	mov    %eax,%edi
    158c:	e8 cc fd ff ff       	call   135d <func> #调用func
    1591:	90                   	nop

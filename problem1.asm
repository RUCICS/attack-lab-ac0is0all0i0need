...
0000000000401258 <main>:
  ...
  40127e:	83 bd ec fe ff ff 02 	cmpl   $0x2,-0x114(%rbp) #看看main函数输入的参数是不是两个
  401285:	74 2d                	je     4012b4 <main+0x5c> #  -> 跳到b4
  ...
  4012b4:	48 8b 85 e0 fe ff ff 	mov    -0x120(%rbp),%rax # 如果输入是两个 将第二个参数传到rax
  4012bb:	48 83 c0 08          	add    $0x8,%rax 
  4012bf:	48 8b 00             	mov    (%rax),%rax # 输入的第二个一定是地址，且加8之后会偏移到想要的位置
  4012c2:	be 37 20 40 00       	mov    $0x402037,%esi # esi =  0x402037
  4012c7:	48 89 c7             	mov    %rax,%rdi # rdi = *(rax + 8)
  4012ca:	e8 31 fe ff ff       	call   401100 <fopen@plt> # ? 这个函数是需要两个参数的，一个是文件名，一个是模式 ---***第一个打开的文件
  4012cf:	48 89 45 f8          	mov    %rax,-0x8(%rbp) 
  4012d3:	48 83 7d f8 00       	cmpq   $0x0,-0x8(%rbp) # 查看返回值是不是零，如果是零则打开失败 成功则跳转到 ee
  ...
  401309:	e8 c2 fd ff ff       	call   4010d0 <fread@plt> --**第二个打开的文件
  ...
  40132a:	e8 b1 fd ff ff       	call   4010e0 <fclose@plt> --* 关闭第一个
  40132f:	b8 01 00 00 00       	mov    $0x1,%eax
  401334:	eb 3b                	jmp    401371 <main+0x119>
  401336:	48 8d 95 f0 fe ff ff 	lea    -0x110(%rbp),%rdx # 跳转到这
  ...
  40134e:	e8 8d fd ff ff       	call   4010e0 <fclose@plt> --*关闭第二个
